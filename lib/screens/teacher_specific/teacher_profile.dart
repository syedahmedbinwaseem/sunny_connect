...
class _TeacherProfileState extends State<TeacherProfile> {
  ...
  void _loadData() {
    ...
    department.text = CurrentAppUser.currentUserData.department;
      ...
      child: Form(
        child: Column(
          children: [
            ...
            //       AppLocalizations.of(context).phone_number, false, TextInputAction.next, number, validtor: FieldValidator.validateField, readOnly: readOnly, keyboardType: TextInputType.number),
            // ),
            const SizedBox(height: 10),
            Padding(
              padding: const EdgeInsets.only(right: 20),
            ...
            readOnly
                ...
                : Container(
                    ...
                    onPressed: () async {
                      ...
                      bool res = await DatabaseServie.updateTeacherdata(
